...
public class StatisticsTool 
{
				...
				if (filename.endsWith(".class")) {
					...
					for (Enumeration e = ci.getRoutines().elements(); e.hasMoreElements(); ) {
						...
						if(routine.getMethodName().equals("solveImage")){
							routine.addBefore("StatisticsTool", "startTime", "null");
							routine.addAfter("StatisticsTool", "stopTime", "null");
    ...
    public static synchronized void startTime(String foo){
	time = System.currentTimeMillis();
    }

    public static synchronized void stopTime(String foo){
