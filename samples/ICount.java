...
public class ICount {
	...
	try {
		String test = "" + i_count + " instructions in " + b_count + " basic blocks were executed in " + m_count + " methods.";
		BufferedWriter writer = new BufferedWriter(new FileWriter("icount.txt"));
		writer.write(test);
		writer.close();
	} catch (IOException e) {
		e.printStackTrace();
